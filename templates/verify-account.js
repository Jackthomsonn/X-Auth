...
const VerifyTemplateBeta = `<!doctype html>
...
<body>
  <div style="display:none;font-size:1px;color:#ffffff;line-height:1px;max-height:0px;max-width:0px;opacity:0;overflow:hidden;"> Verify your {{ applicationName }} account </div>
  <div style="">
    <!--[if mso | IE]>
      <table
    ...
    <div style="Margin:0px auto;max-width:600px;">
      ...
      <![endif]-->
                  ...
                  <tr>
                    <td align="center" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                      <div style="font-family:helvetica;font-size:20px;font-weight:700;line-height:1;text-align:center;color:${env.THEME_COLOUR || '#222'};"> Verify your {{ applicationName }} account </div>
                    </td>
                  </tr>
                  <tr>
                    <td align="center" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                      <div style="font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:14px;font-weight:400;line-height:1;text-align:center;color:#222222;"> Use the button below to verify your {{ applicationName }} account </div>
                    </td>
                  </tr>
                  <tr>
                    <td align="center" vertical-align="middle" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                      <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="border-collapse:separate;line-height:100%;">
                        <tr>
                          <td align="center" bgcolor="${env.THEME_COLOUR || '#222'}" role="presentation" style="border:none;border-radius:4px;cursor:auto;height:40px;padding:10px 25px;background:${env.THEME_COLOUR || '#222'};" valign="middle">
                            <p style="background:${env.THEME_COLOUR || '#222'};color:#ffffff;font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:13px;font-weight:500;line-height:120%;Margin:0;text-decoration:none;text-transform:none;" href="${url}"> Verify account </p>
                          </td>
                        </tr>
                      </table>
                    </td>
