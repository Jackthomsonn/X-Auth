...
const VerifyPhoneNumberChangeTemplate = (url) => {
  return `<!doctype html>
    ...
    <div style="">
      ...
      <div style="Margin:0px auto;max-width:600px;">
        ...
        <![endif]-->
                    ...
                    <tr>
                      <td align="center" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                        <div style="font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:14px;line-height:1;text-align:center;color:#000000;"> It looks like you requested to update your phone number for ${env.APP_NAME}. If this was you, click the button below but if not, please disregard this email </div>
                      </td>
                    </tr>
                    <tr>
          ...
          <tr>
                    <td align="center" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                      <div style="font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:13px;line-height:1;text-align:center;color:#000000;"> (This link will expire in ${ms(env.UPDATE_PROFILE_JWT_EXPIRATION)}) </div>
                    </td>
                  </tr>
        </table>
      </div>
...
module.exports = VerifyPhoneNumberChangeTemplate